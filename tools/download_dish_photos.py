...
SEARCH: dict[str, str] = {
    ...
    "pao-de-forma": "sandwich bread loaf",
    "pao-integral": "whole wheat bread loaf",
    "paezinhos-rapidos": "dinner rolls biscuits",
    "pao-sirio": "pita bread flatbread",
    "broinhas-de-fuba": "cornmeal cookies brazilian",
    "muffins": "muffins baking",
    "rosca-de-natal": "christmas wreath cake",
    "bolo-merenda": "chocolate cake slice",
    "bolo-de-especiarias": "spice cake",
    "bolo-de-mandioca": "cassava cake brazilian",
    "bolo-de-chocolate": "chocolate cake slice",
    "bolo-de-laranja": "orange cake slice",
    "bolo-de-abacaxi": "pineapple upside down cake",
    "bolo-de-fuba-e-coco": "cornmeal coconut cake",
    "bolo-gelado-de-goiaba": "guava cake brazilian",
    "bolo-de-sorvete-com-cerejas": "ice cream cake cherries",
    "cheesecake-basco-de-chocolate": "chocolate basque cheesecake",
    "biscoitinhos-coloridos": "colorful cookies",
    "biscoitinhos-de-cerveja": "beer cookies",
    "biscoitinhos-de-ameixa-preta": "prune cookies",
    "biscoitinhos-de-chocolate-e-coco": "chocolate coconut cookies",
    "biscoitinhos-de-caramelo": "caramel cookies",
    "esquecidos": "brazilian cookies esquecidos",
    "casadinhos-recheados": "casadinhos cookies brazilian",
    "sequilhos-de-coco": "coconut cookies brazilian",
    "waffles-com-iogurte": "waffles breakfast",
    "bolo-de-chocolate-com-3-ingredientes": "flourless chocolate cake",
}
